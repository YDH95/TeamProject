					...
					<div class="col-xl-12">
						<div class="card shadow mb-4">
							...
							<div class="card-header" style="height: 50px;">
								<h4>
									<span style="float: left;font-weight: bold; color: #e43c;">리뷰관리</span>
									 <span
										style="float: right;">
										...
										<div class="card">
											<div class="card text-dark bg-light">
												...
												<img src="/resources/assets/img/reviewpic/${review.rvimg}"
													class="card-img-top" width="300" height="250">
						...
						<div>
							<a href="/admin/proreview.do"><input type="button"	class="resv_btn" style="font-size: 20px; text-align: center; float: right;"
								value="리뷰 등록"></a>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(function() {
			$('.more-btn').on(
					...
					function() {
						var self = $(this)
						var content_wrap = self.closest('tbody').find(
								'.content-wrap')
						if ($(this).children().is('.open')) {
							$(this).html('<p class="close">닫기</p>').addClass(
									'close-btn');
							content_wrap.addClass('slide-down')
						} else {
							$(this).html('<p class="open">더보기</p>')
									.removeClass('close-btn');
							content_wrap.removeClass('slide-down')
						}
					});
		});
	</script>
