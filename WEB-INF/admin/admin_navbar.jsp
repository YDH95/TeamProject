...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false">
			 <span style="line-height:70px" class="mr-2 d-none d-lg-inline text-gray-600 large">
				${sessionScope.nick}님
			</span> 
				<img class="img-profile rounded-circle"	src="/resources/assets/img/userpic/${sessionScope.photo}" >
			</a>
		</li>
