								...
								<div class="card-body">
									<table>
										...
										<tr>
											...
											<td>
												<div class="wrapper">
													<input type="radio" name="rvscore"
														id="star-1" value="1" required>
												  	<input type="radio" name="rvscore"
														id="star-2" value="2" required>
													<input type="radio" name="rvscore"
													  	id="star-3" value="3" required>
													<input type="radio" name="rvscore" 
														id="star-4" value="4" required>
													<input type="radio" name="rvscore"
										...
										<tr>
											<td>
												<button type="submit" class="resv_btn">리 뷰 등 록</button>
											</td>
										</tr>
									</table>
								</div>
